...
This section is adapted from the source code {\bf calculus/whatIsALimit/digInContinuity.tex} available at \url{https://github.com/mooculus/calculus}.
...
\begin{explanation}
  ...
  cannot be continuous at $x=\answer[given]{2}$ as you must lift your pen over the hole in the graph.
