...
\input{../masterfiles/calculus-master/preamble.tex}
...
\begin{explanation}
  ...
  \]
  This causes a ``jump'' in the function at $x=4$, and $f$ cannot be continuous
  at $x=4$.
...
\begin{remark}
The following common functions are continuous at every $x$-value in their domains.  Try visualizing their graphs to convince yourself of this.  Here $k$ is a real number and $b$ is a positive real number.
\begin{description}
