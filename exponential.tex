...
\end{example}
 \begin{explanation}
in this example, we want to write both sides of the equation as a power of $3$.  Once we have the same base, we may equate exponents.
We may write $27=3^{\answer[given]{3}}$ and $9=3^{\answer[given]{2}}$, therefore we can write the exponential equation as 
 \[
